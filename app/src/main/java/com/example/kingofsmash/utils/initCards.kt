...
fun initAllCards() : MutableList<Card>{
    ...
    cards.add(Card(3, "Deal 1 damage to all enemies", CardType.DAMAGE_ALL_ONE))
    ...
    cards.add(Card(3, "Gain 1 smash", CardType.SMASH_UP_ONE))
    cards.add(Card(6, "Gain 2 smash", CardType.SMASH_UP_TWO))
